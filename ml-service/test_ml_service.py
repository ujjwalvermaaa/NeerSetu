#!/usr/bin/env python3
"""
Test script for NeerSetu ML Service
...
def test_model_trainer():
    ...
    # Test model training
    training_result = model_trainer.train_models(features, target, ['xgboost', 'random_forest'])
    ...
    if training_result['success']:
        ...
        # Test model loading
        load_success = model_trainer.load_model('test_model')
...
def test_api_endpoints():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   ✅ Health check: {health_data.get('success', False)}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   ✅ Status check: {status_data.get('success', False)}")
        else:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   ✅ Prediction: {pred_data.get('success', False)}")
            if pred_data.get('success'):
                print(f"   📊 Risk Index: {pred_data.get('risk_index', 0)}")
...
def main():
    """Run all tests"""
    print("🚀 NeerSetu ML Service Test Suite")
    print("=" * 50)
